                    ...
                    <div className="band1">
                        <div className="container">
                            <ul className="datos">
                                ...
                                <li>
                                    <svg viewBox="0 0 512 512"><path d="M487.8 24.1L387 .8a31.3 31.3 0 0 0-35.8 18.1l-46.5 108.5a31.4 31.4 0 0 0 8.9 36.5l53.9 44.1a350 350 0 0 1-159.6 159.6l-44.1-53.9a31.4 31.4 0 0 0-36.5-8.9L18.9 351.3C5 357.3-2.6 372.3.8 387L24 487.7A31.2 31.2 0 0 0 54.5 512 457.4 457.4 0 0 0 512 54.5a31 31 0 0 0-24.2-30.4zM55.1 480l-23-99.6 107.4-46 59.5 72.8c103.6-48.6 159.7-104.9 208.1-208.1l-72.8-59.5 46-107.4 99.6 23A425.3 425.3 0 0 1 55.1 480z"/></svg>
                                    &nbsp;2314 427308</li>
                                <li>
                                        ...
                                        <div className="collapse navbar-collapse" id="navbar">
                                            <ul className="navbar-nav mr-auto">
                                                ...
                                                <li className="nav-item"><a className="nav-link" href="#">Acceso a
                                                    clientes</a></li>
                                                <li className="nav-item"><a className="nav-link" href="contacto.php">Contacto</a></li>
                                            </ul>
                                        </div>
                                    </nav>
                                    <div className="social top">
                                        <a href="https://www.facebook.com/lared.wifi" target="_blank" className="social-icon">
                                            <svg viewBox="0 0 320 512"><path d="M279.1 288l14.3-92.7h-89v-60c0-25.4 12.5-50.2 52.3-50.2H297V6.4S260.4 0 225.4 0C152 0 104.3 44.4 104.3 124.7v70.6H22.9V288h81.4v224h100.2V288z"/></svg>
                                            </a>
