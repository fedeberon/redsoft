...
<head>
    ...
    <link href="<c:url value='/assets/plugins/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css' />"
          rel="stylesheet">
    <link href="<c:url value='/assets/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css' />"
          rel="stylesheet">
    <link href="<c:url value='/assets/plugins/select2/css/select2.min.css' />" rel="stylesheet">
    <link href="<c:url value='/assets/plugins/bootstrap4-duallistbox/bootstrap-duallistbox.min.css' />"
          rel="stylesheet">
    <link href="<c:url value='/assets/dist/css/adminlte.min.css' />" rel="stylesheet">
    <link href="<c:url value='https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700' />"
          rel="stylesheet">
</head>
<body>
<div class="wrapper">
...
<script type="text/javascript"
        src='<c:url value="/assets/plugins/bootstrap4-duallistbox/jquery.bootstrap-duallistbox.min.js"/>'></script>
<script type="text/javascript" src='<c:url value="/assets/plugins/moment/moment.min.js"/>'></script>
<script type="text/javascript"
        src='<c:url value="/assets/plugins/inputmask/min/jquery.inputmask.bundle.min.js"/>'></script>
<script type="text/javascript" src='<c:url value="/assets/plugins/daterangepicker/daterangepicker.js"/>'></script>
<script type="text/javascript"
        src='<c:url value="/assets/plugins/bootstrap-colorpicker/js/bootstrap-colorpicker.min.js"/>'></script>
<script type="text/javascript"
        src='<c:url value="/assets/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js"/>'></script>
<script type="text/javascript"
        src='<c:url value="/assets/plugins/bootstrap-switch/js/bootstrap-switch.min.js"/>'></script>
